...
enum class OrbitalPassBoundary {
    ACTUAL,
    WINDOW_CLIPPED
}
...
data class OrbitalPass(
    ...
    val tcaTime: Long = (aosTime + losTime) / 2,
    val aosBoundary: OrbitalPassBoundary = OrbitalPassBoundary.ACTUAL,
    val losBoundary: OrbitalPassBoundary = OrbitalPassBoundary.ACTUAL
) {
